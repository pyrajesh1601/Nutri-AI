...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-brand/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      >
        ...
        <div className="glass p-10 rounded-4xl border border-white/10 relative overflow-hidden">
          ...
          <p className="text-text-secondary font-light mb-8">Welcome back to your health journey.</p>
